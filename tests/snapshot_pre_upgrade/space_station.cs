...
public class SpaceStation {
    ...
    public Dictionary<string, int> resource_levels = null;
    public SpaceStation(string name, int capacity) {
        this.modules = new List<object> { "Command", "Life Support", "Laboratory" };
        this.resource_levels = new Dictionary<object, object> { { "Oxygen", 95 }, { "Power", 100 } };
    }
