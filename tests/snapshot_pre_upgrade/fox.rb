...
def main
  ...
  fox_list[0] = 100
  fox_list.append(4)
  puts(("fox_list0=" + builtins_py.str(fox_list[0])))
  puts(("fox_list_len=" + builtins_py.str(builtins_py.len(fox_list))))
  puts(("fox_list_last=" + builtins_py.str(fox_list[3])))
  fox_map = builtins_py.hashmap()
  fox_map["quick"] = 1
  fox_map["brown"] = 2
  fox_map["fox"] = 3
  puts(("map_get_brown=" + builtins_py.str(fox_map.get("brown"))))
  fox_map["fox"] = 30
  puts(("map_get_fox=" + builtins_py.str(fox_map.get("fox"))))
  name = "fox"
  speed = 12
  ...
  puts(("contains_fox=" + bool_str(("fox" in words))))
  puts(("contains_wolf=" + bool_str(("wolf" in words))))
  puts(("contains_key=" + bool_str(("quick" in fox_map))))
  puts("DONE")
end
