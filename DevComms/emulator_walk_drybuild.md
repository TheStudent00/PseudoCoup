...
top-level `DevComms/*.md`/`PROGRESS*.md` docs exist under `~/Programming/PseudoCoup` at the
...
`emu_walker.py` and `emuwalk_utils.py` have been moved to `~/Programming/WFL_MixingCenter/render/`
...
`~/Programming/WFL_MixingCenter/WFL/app/src/main/java/com/sara/workoutforlife/...`), not
