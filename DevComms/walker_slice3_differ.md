...
## Files touched
- `~/Programming/WFL_MixingCenter/render/walker.py` (three paired changes + frontier-hang fix)
- `~/Programming/WFL_MixingCenter/render/walk_diff.py` (new — the differ)
- `~/Programming/WFL_MixingCenter/render/walks/py_walk_runA.json`,
...
- `~/Programming/PseudoCoup/DevComms/hostruns/requests/088_py_walk_runA.json` (removed after it
