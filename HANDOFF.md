...
You are continuing an ongoing engineering loop with <user>. Read this file, then `PROGRESS_ondeck.md`
...
**The only open item: <user>'s acceptance drive.** He taps around the real app; anything that feels
