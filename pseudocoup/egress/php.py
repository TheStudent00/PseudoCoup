...
class PhpGenerator:
    ...
    def _visit(self, node: PseudoNode):
        if node.type == NODE_ASSIGNMENT:
            ...
            # PHP is dynamically typed, but requires $ prefix
            # The _expr() method already prepends $ to identifiers
            ...
            if func_str == "print":
                self._add_line(f'print({args_str});')
            else:
