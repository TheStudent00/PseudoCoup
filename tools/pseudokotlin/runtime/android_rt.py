...
# ---- androidx.room builder (the schema/DAO bodies are generated by Room -> the data-layer gap) -- #
class Room:
    @staticmethod
    def databaseBuilder(*a, **k):
        return _Stub()


def Update(x=None):               # @Update annotation if it survives -> identity / no-op
    return x
