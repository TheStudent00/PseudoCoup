...
Status date: 2026-07-14. Classification ratified by the owner as decision D2 (see
...
| 2 | Coverage hooks in the other 10 ingestors | n/a (new work, ~4 lines each) | UPSTREAM | deferred | Cross-language behavior change; per U5 escalation rule ("confirm scope with the owner before touching more than Kotlin") this is deferred, not silently done |
